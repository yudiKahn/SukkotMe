...
const AddEducation = ({history, addEducation}) => {
    ...
    const [isToDis, toggleToDate] = useState(false);
        ...
        <div className="form-group">
         ...
         <div className="form-group">
          <p><input type="checkbox" name="current" checked={current} value={current} onChange={e=>{
              ...
              toggleToDate(!isToDis);
          }} /> Current School</p>
        </div>
        <div className="form-group">
          <h4>To Date</h4>
          <input type="date" name="to" value={to} onChange={e=>onChange(e)} disabled={isToDis ?'diabled':''}/>
        </div>
        <div className="form-group">
          <textarea name="description" cols="30" rows="5" placeholder="School Description"
